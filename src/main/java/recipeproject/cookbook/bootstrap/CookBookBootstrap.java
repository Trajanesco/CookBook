...
public class CookBookBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachUomOptional = unitMeasureRepository.findByUom("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> tablespoonUomOptional = unitMeasureRepository.findByUom("Tablespoon");

        if(!tablespoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> teaspoonUomOptional = unitMeasureRepository.findByUom("Teaspoon");

        if(!teaspoonUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOptional = unitMeasureRepository.findByUom("Dash");
        ...
        Optional<UnitOfMeasure> cupUomOptional = unitMeasureRepository.findByUom("Cup");
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. \n" +
                ...
                " cover it and to prevent air reaching it. " +
        ...
        guacRecipe.setSourceUrl("http://www.simplyrecipes.com/recipes/perfect_guacamole/");
        ...
        tacosRecipe.addIngredient(new Ingredient("medium ripe avocados, slices", new BigDecimal(2), eachUom));
